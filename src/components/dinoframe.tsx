...
export default function FrameCallbackDino() {
  ...
  useFrameCallback((frameInfo) => {
    ...
    obstacleX.value = obstacleX.value > -100 ? obstacleX.value - vx.value * dt : width.value;
  ...
  const obstacleStyles = useAnimatedStyle(() => ({
    transform: [{ translateX: obstacleX.value }, { translateY: DEFAULT_OBSTACLE.y }],
  }));
  ...
  return (
    <>
      ...
      <Pressable style={styles.container} onLayout={getDimensions} onPressIn={handleTap}>
        ...
        <Animated.Text style={[styles.obstacle, obstacleStyles]}>🌵</Animated.Text>
